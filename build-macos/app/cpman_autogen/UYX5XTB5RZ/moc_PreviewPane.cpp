/****************************************************************************
** Meta object code from reading C++ file 'PreviewPane.h'
**
...
#error "The header file 'PreviewPane.h' doesn't include <QObject>."
...
template <> constexpr inline auto PreviewPane::qt_create_metaobjectdata<qt_meta_tag_ZN11PreviewPaneE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(qint64, bool)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::LongLong, 3 }, { QMetaType::Bool, 4 },
        }}),
        // Slot 'onHeart'
...
void PreviewPane::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->favoriteToggled((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        case 1: _t->onHeart(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PreviewPane::*)(qint64 , bool )>(_a, &PreviewPane::favoriteToggled, 0))
            return;
    }
}
...
// SIGNAL 0
void PreviewPane::favoriteToggled(qint64 _t1, bool _t2)
{
