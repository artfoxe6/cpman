...
void TrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->togglePopupRequested(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TrayIcon::*)()>(_a, &TrayIcon::togglePopupRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrayIcon::*)()>(_a, &TrayIcon::settingsRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrayIcon::*)()>(_a, &TrayIcon::quitRequested, 2))
            return;
    }
}
...
// SIGNAL 0
void TrayIcon::togglePopupRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TrayIcon::settingsRequested()
{
